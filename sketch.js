  ...
  var grassHeight = 100;
  var gameState = "play";
  var carAnimation, logAnimation, playerAnimation,playerImage;
  var school;
  ...
  function setup() 
  {
   ...
   city.addAnimation("city1",cityAnimation);
  ...
  if(city.isTouching(player.spt))
  {
    ...
    if(gameState === "WIN")
    {
      ...
      fill("Green");
      textSize(40);
      text("CONGRATS! YOU MADE IT.",width/2-250,-1800);
  ...
  function keyPressed()
  {
     if(keyCode == UP_ARROW){ player.move(0,-2);
  }
